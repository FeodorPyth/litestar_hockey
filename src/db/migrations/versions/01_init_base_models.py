...
def schema_upgrades() -> None:
    ...
    sa.Column('created_at', sa.DateTimeUTC(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTimeUTC(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['city_id'], ['cities.id'], name=op.f('fk_stadiums_city_id_cities'), ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['stadium_id'], ['stadiums.id'], name=op.f('fk_teams_stadium_id_stadiums'), ondelete='CASCADE'),
    ...
    with op.batch_alter_table('coaches', schema=None) as batch_op:
        ...
        batch_op.create_index('unique_head_coach_per_team', ['team_id'], unique=True, postgresql_where=sa.text('is_head_coach IS TRUE'))
